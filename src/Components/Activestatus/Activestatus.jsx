      ...
      <Card  className='status_head'>
        <Row>
            <Col className='col-lg-2'>
              <Card style={{ width: "145px", height: "140px" ,border:'1px solid black',marginTop:"5px",marginLeft:"-5px",borderRadius:"15px",backgroundColor:"white"}}>
            ...
            <Col className='col-lg-2 activestatus-secound'>
              <Card style={{ width: "145px", border:'1px solid black',height: "140px",borderRadius:"15px",marginTop:"5px",marginLeft:"95px",backgroundColor:"white" }}>
                <div>
